...
namespace ProteinDigestionSimulator
{
    public partial class FastaValidation : Form
    {
        ...
        private CheckBox chkWrapLongResidueLines;
        private CheckBox chkSplitOutMultipleRefsForKnownAccession;
        private CheckBox chkTruncateLongProteinNames;
        private TextBox txtResults;
        private TabPage TabPageErrorOptions;
        private CheckBox chkSaveBasicProteinHashInfoFile;
        private Label lblProteinNameLengthUnits;
        private Label lblProteinNameLength2;
        private TextBox txtProteinNameLengthMaximum;
        private TextBox txtProteinNameLengthMinimum;
        private Label lblProteinNameLength;
        private TextBox txtMaximumResiduesPerLine;
        private Label lblMaximumResiduesPerLine;
        private CheckBox chkAllowAsteriskInResidues;
        private CheckBox chkCheckForDuplicateProteinInfo;
        private TextBox txtMaxFileErrorsToTrack;
        private Label lblMaxFileErrorsToTrack;
        private CheckBox chkLogResults;
        private CheckBox chkConsolidateDupsIgnoreILDiff;
        private CheckBox chkRemoveInvalidResidues;
        private TabPage TabPageNewFastaOptions;
        private CheckBox chkConsolidateDuplicateProteinSeqs;
        private CheckBox chkRenameDuplicateProteins;
        private CheckBox chkSplitOutMultipleRefsInProteinName;
        private TextBox txtInvalidProteinNameCharsToRemove;
        private Label lblInvalidProteinNameCharsToRemove;
        private TextBox txtLongProteinNameSplitChars;
        private Label lblLongProteinNameSplitChars;
        private CheckBox chkGenerateFixedFastaFile;
        private Label lblCustomRulesFile;
        private TabPage TabPageRuleOptions;
        private Button cmdCreateDefaultValidationRulesFile;
        private TextBox txtCustomValidationRulesFilePath;
        private Button cmdSelectCustomRulesFile;
        private TabControl tbsOptions;
        private MenuItem mnuEditCopyAllWarnings;
        private MainMenu MainMenuControl;
        private MenuItem mnuFile;
        private MenuItem mnuFileExit;
        private MenuItem mnuEdit;
        private MenuItem mnuEditCopyAllResults;
        private MenuItem mnuEditSep1;
        private MenuItem mnuEditCopySummary;
        private MenuItem mnuEditCopyAllErrors;
        private MenuItem mnuEditSep2;
        private MenuItem mnuEditFontSizeDecrease;
        private MenuItem mnuEditFontSizeIncrease;
        private MenuItem MenuItem2;
        private MenuItem mnuEditResetToDefaults;
        private MenuItem MenuItem1;
        private MenuItem mnuHelpAbout;
        private DataGrid dgWarnings;
        private Label lblFilterData;
        private TextBox txtFilterData;
        private ProgressBar pbarProgress;
        private Button cmdValidateFastaFile;
        private DataGrid dgErrors;
        private Button cmdCancel;
        private CheckBox chkKeepDuplicateNamedProteins;
        private TextBox txtResiduesPerLineForWrap;
        private Label lblResiduesPerLineForWrap;
    }
}