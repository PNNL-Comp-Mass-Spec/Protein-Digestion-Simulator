...
Copy "D:\My Documents\Projects\DataMining\NET_Prediction_Utility\NETPredictionUtility_SourceCode\*.zip" .
Copy "D:\My Documents\Projects\DataMining\DMS_Managers\PRISM_Class_Library\PRISM_Class_Library_Source*.zip" .
Copy "D:\My Documents\Projects\DataMining\ProgressFormDLL\ProgressForm_SourceCode\*.zip" .
...
Copy "D:\My Documents\Projects\DataMining\SmoothProgressBarDLL\SmoothProgressBar_SourceCode\*.zip" .
Copy "D:\My Documents\Projects\DataMining\Validate_Fasta_File\ValidateFastaFile_SourceCode\*.zip" .
