...
Set ProgramName=ProteinDigestionSimulator
...
Set InstallerFolder=%ProgramName%_Installer\Output
...
"c:\program files\winrar\winRar.exe" a -ep %ZippedInstallerFile% ..\%InstallerFolder%\*.exe
