...
#End Region
    ...
    Public Sub InitializeControls()
        ...
        mTimerStartTime = System.DateTime.Now
    ...
    Private Sub mCloseDelayTimer_Elapsed(ByVal sender As Object, ByVal e As System.Timers.ElapsedEventArgs) Handles mCloseDelayTimer.Elapsed
        Dim intSecondsRemaining As Integer

        intSecondsRemaining = CInt(Math.Round(FORM_CLOSE_DELAY_SECONDS - System.DateTime.Now.Subtract(mTimerStartTime).TotalSeconds, 0))
